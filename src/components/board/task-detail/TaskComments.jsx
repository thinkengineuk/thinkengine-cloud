  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      for (const email of mentions) {
        ...
        const conversationHtml = conversationItems.map(item => `
...
<html lang="en">
<head><meta charset="UTF-8"/><meta name="viewport" content="width=device-width,initial-scale=1.0"/><title>You were mentioned</title></head>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:580px;">
        <tr>
          <td style="background:linear-gradient(135deg,#1e3a5f 0%,#2563eb 100%);border-radius:10px 10px 0 0;padding:28px 32px;text-align:center;">
            ...
            <div style="font-size:22px;font-weight:700;color:#ffffff;">You were mentioned</div>
          </td>
        </tr>
        <tr>
          <td style="background:#ffffff;padding:32px;border-left:1px solid #e2e8f0;border-right:1px solid #e2e8f0;">
            <p style="font-size:15px;color:#1e293b;margin:0 0 12px 0;">Hi ${mentionedUser?.full_name || 'there'},</p>
            <div style="font-size:15px;color:#475569;line-height:1.6;margin-bottom:20px;">
              <strong>${currentUser.full_name}</strong> mentioned you on the task <strong>${taskData.title}</strong>.
            </div>
